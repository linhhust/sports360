<div class="layout__HeaderLayoutItem-sc-1sp98x0-1 cOcpRB">
	<button class="button__Button-sc-1kryk61-2 bGovrs">
		<span class="button__ButtonIcon-sc-1kryk61-1 nOOFq">
			<svg width="1em" height="1em" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconHamburger-o0jnrl-0 icons__HeaderIconHamburger-sc-3d9i9q-2 kRjNNt">
		...
		<span class="button__ButtonText-sc-1kryk61-0 fNvhMU">Toggle main menu</span>
	</button>
</div>
		...
		@auth
			<div class="Inline-sc-1rz1cju-0 jtWmMp" style="overflow: visible;">
			    ...
			    <button class="button__Button-sc-1kryk61-2 lkmuTB">
			        <span class="button__ButtonIcon-sc-1kryk61-1 nOOFq">
			            <div class="HeaderProfileLoyalty__Wrapper-fjzvk2-0 ccxVLf">
			                <div class="HeaderProfileLoyalty__Progressbar-fjzvk2-1 bYFynF">
			                    <svg class="CircularProgressbar" viewBox="0 0 100 100" data-test-id="CircularProgressbar" style="width: 100%; vertical-align: middle;">
			                        <path class="CircularProgressbar-trail" d="
			                          M 50,50
			                          m 0,-47
			                          a 47,47 0 1 1 0,94
			                          a 47,47 0 1 1 0,-94
			                        " stroke-width="6" fill-opacity="0" style="stroke: rgb(53, 60, 68); stroke-dasharray: 295.31px, 295.31px; stroke-dashoffset: 0px;"></path>
			                        <path class="CircularProgressbar-path" d="
			                          M 50,50
			                          m 0,-47
			                          a 47,47 0 1 1 0,94
			                          a 47,47 0 1 1 0,-94
			                        " stroke-width="6" fill-opacity="0" style="stroke: rgb(12, 212, 99); transition: none 0s ease 0s; stroke-dasharray: 295.31px, 295.31px; stroke-dashoffset: 295.31px;"></path>
			                    </svg>
			                </div>
			                <div class="HeaderProfileLoyalty__ImgWrapper-fjzvk2-2 feDVqj">
			                    <img alt="Steel" src="https://sportsbet.imgix.net/2020/!The%20Clubhouse%20(SB%20Loyalty)/Lvl1_Steel_512.png?auto=compress,enhance,format">
			                </div>
			            </div>
			        </span>
			    ...
			    <span>
			        <button class="button__Button-sc-1kryk61-2 lkmuTB">
			            <span class="button__ButtonIcon-sc-1kryk61-1 nOOFq">
			                <svg width="1em" height="1em" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconNotificationUnread-l7xkmo-0 icons__IconNotificationUnread-sc-3d9i9q-4 klfqbn">
			                    <circle cx="9.011" cy="1.539" r="1.039" stroke="currentColor"></circle>
			                    <path d="M11.357 17.19c0 1.276-1.05 2.31-2.346 2.31s-2.346-1.034-2.346-2.31" stroke="currentColor"></path>
			                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.01 3.836c-2.57 0-4.685 2.17-4.685 4.888h-1c0-3.234 2.528-5.888 5.686-5.888 1.416 0 2.705.533 3.697 1.414a4.112 4.112 0 00-.962.505 4.54 4.54 0 00-2.735-.92zm5.625 8.383c.162.183.35.354.573.508l.01.007.011.007h.001l.01.007.044.03a4.336 4.336 0 01.704.613c.394.428.733.985.733 1.619 0 .56-.123.856-.277 1.016-.15.156-.423.28-.951.28h-4.754v1h4.753c.665 0 1.257-.154 1.672-.586.412-.428.557-1.031.557-1.71 0-.994-.525-1.784-.996-2.296a5.347 5.347 0 00-.941-.805l-.005-.004a4.1 4.1 0 01-1.144.314zM4.325 8.785c0 1.037.002 2.893-1.512 3.942l-.01.007-.01.007H2.79l-.01.007-.044.03a4.333 4.333 0 00-.704.613c-.394.428-.733.985-.733 1.619 0 .56.123.856.277 1.016.15.156.423.28.952.28h8.21v1h-8.21c-.665 0-1.257-.154-1.672-.586C.445 16.292.3 15.689.3 15.01c0-.994.525-1.784.996-2.296a5.345 5.345 0 01.941-.805l.015-.01c1.04-.727 1.073-2.046 1.073-3.175h1v.061z" fill="currentColor"></path>
			                    <path d="M14.08 10.257c1.11 0 2.011-.92 2.011-2.054 0-1.135-.9-2.054-2.012-2.054-1.11 0-2.011.92-2.011 2.054s.9 2.054 2.011 2.054z" fill="currentColor"></path>
			                </svg>
			            </span>
			            <span class="button__ButtonText-sc-1kryk61-0 fNvhMU">1 Notifications</span>
			        </button>
			    </span>
			    <button class="button__Button-sc-1kryk61-2 ggTfbD btn-deposit">
			        <span class="button__ButtonIcon-sc-1kryk61-1 nOOFq">
			            <svg viewBox="0 0 20 20" width="1em" height="1em" xmlns="http://www.w3.org/2000/svg" class="IconAdd-sc-1m2b034-0 TSxqm">
			                <path fill-rule="evenodd" clip-rule="evenodd" d="M16 9h-5V4c0-.55-.45-1-1-1s-1 .45-1 1v5H4c-.55 0-1 .45-1 1s.45 1 1 1h5v5c0 .55.45 1 1 1s1-.45 1-1v-5h5c.55 0 1-.45 1-1s-.45-1-1-1z" fill="currentColor"></path>
			            </svg>
			        </span>
			        <span class="button__ButtonText-sc-1kryk61-0 fNvhMU">Deposit</span>
			    </button>
			</div>
		@endauth
	</div>
