            ...
            <div class="layout__IdLayout-h90yrz-0 fgBaNW">
                <div class="layout__IdLayoutBody-h90yrz-2 cxzNhQ">
                    <div class="body__IdBody-sc-1kb3j31-0 iwdBQt">
                        <div class="body__IdBodyItem-sc-1kb3j31-1 dEPATL"><button
                                class="button__IconButton-sc-1357fco-0 bBovPm"><svg width="1em" height="1em"
                        ...
                        <div class="body__IdBodyItem-sc-1kb3j31-1 cjWrGu"><a href="/"
                        ...
                        <div class="body__IdBodyItem-sc-1kb3j31-1 fIAkgN">
                            <div class="sponsorsStyle__SponsorWrapper-sc-16tnrn7-0 cAHSrP">
                                <p color="trunks.100" size="14" class="Text-sc-3hujzp-0 cNILtF">Official Partner of</p>
                                <div class="sponsorsStyle__SponsorsList-sc-16tnrn7-1 hzkZxI"><a
                                        href="/about/sportsbet-io-partnerships"
                                        class="sponsorsStyle__SponsorItem-sc-16tnrn7-2 dqlxGs"><svg width="auto"
                                            height="1em" viewBox="0 0 322.793 379.84" xmlns="http://www.w3.org/2000/svg"
                                            font-size="1.3rem" verticalalign="middle"
                                            class="CrestArsenal-sc-1nz8fsz-0 gKBLYb">
                                            <path fill="#9C824A" stroke="#9C824A" stroke-width="0.793"
                                            ...
                                            <path fill="#023474" stroke="#023474" stroke-width="0.793"
                                                stroke-miterlimit="282"
                                            ...
                                            <path fill="#FFF" stroke="#FFF" stroke-width="0.793" stroke-miterlimit="282"
                                            ...
                                            <path fill="#FFF" d="M154.192 164.504h13.131v30.647h-13.131z"></path>
                                            <path fill="#9C824A" d="M156.25 160.1h9.049v38.958h-9.049z"></path>
                                            <path fill="#FFF"
                                                d="M197.418 181.798l7.169 11.009-25.694 16.693-7.133-11.01z"></path>
                                            <path fill="#9C824A"
                                                d="M202.21 181.124l4.933 7.6-32.651 21.237-4.933-7.635z"></path>
                                            <path fill="#FFF"
                                                d="M142.409 214.187l7.027 11.08-25.872 16.408-7.027-11.116z"></path>
                                            <path fill="#9C824A"
                                                d="M146.81 213.548l4.862 7.671-32.863 20.846-4.863-7.671z"></path>
                                            <path fill="#FFF" d="M154.192 229.281h13.131v30.646h-13.131z"></path>
                                            <path fill="#9C824A" d="M156.25 224.913h9.049v38.922h-9.049z"></path>
                                            <path fill="#EF0107" stroke="#EF0107" stroke-width="0.311"
                                                stroke-miterlimit="282"
                                                d="M148.017 226.013c1.775 1.491 3.726 2.841 6.175 3.871l-.071 27.345c-12.386-1.598-21.755-7.706-28.853-16.406l22.785-14.81">
                                            </path>
                                            <path fill="#DB0007" stroke="#DB0007" stroke-width="0.311"
                                                stroke-miterlimit="282"
                                            ...
                                            <path fill="#FFF" stroke="#FFF" stroke-width="0.311" stroke-miterlimit="282"
                                            ...
                                            <path fill="#9C824A"
                                                d="M115.295 186.522l4.969-7.6 32.544 21.343-4.969 7.601z"></path>
                                            <path fill="#FFF"
                                                d="M172.363 225.232l7.204-11.01 25.623 16.798-7.204 11.01z"></path>
                                            <path fill="#9C824A"
                                                d="M169.984 221.467l4.969-7.599 32.545 21.343-4.969 7.565z"></path>
                                        </svg></a><a href="/about/sportsbet-io-partnerships"
                                        class="sponsorsStyle__SponsorItem-sc-16tnrn7-2 dqlxGs"><svg width="auto"
                                            height="1em" viewBox="0 0 355.508 405.592"
                                            xmlns="http://www.w3.org/2000/svg" font-size="1.3rem" verticalalign="middle"
                                            class="CrestSouthampton-sc-1tik4et-0 jCNltN">
                                            <path fill="#211E1F"
                                            ...
                                            <path fill="none" stroke="#FFF" stroke-width="2.356"
                                            ...
                                            <path fill="none" stroke="#211E1F" stroke-width="1.441"
                                            ...
                                            <path fill="none" stroke="#FFC40D" stroke-width="0.571"
                                            ...
                                            <path fill="none" stroke="#211E1F" stroke-width="5.901"
                                            ...
                                            <path fill="none" stroke="#211E1F" stroke-width="4.704"
                                            ...
                                            <path fill="none" stroke="#211E1F" stroke-width="0.002"
                                            ...
                                            <path fill="none" stroke="#211E1F" stroke-width="9.436"
                                        ...
                                        class="sponsorsStyle__SponsorItem-sc-16tnrn7-2 dqlxGs"><svg width="auto"
                                            height="1em" viewBox="0 0 260 320" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" font-size="1.3rem" verticalalign="middle"
                                            class="CrestFlamengo-c4scqm-0 fMtGkM">
                                            <path
                                        ...
                                        class="sponsorsStyle__SponsorItem-sc-16tnrn7-2 dqlxGs"><svg width="auto"
                                            height="1em" viewBox="0 0 216 248" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" font-size="1.3rem" verticalalign="middle"
                                            class="CrestWatford-sc-39g5ai-0 kAWslK">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="body__IdBodyItem-sc-1kb3j31-1 jBPoYd">
                            <form class="Form___StyledForm-sc-11bajar-1 bwvtHp Login__CustomForm-sc-1msby7y-0 eUJYKP">
