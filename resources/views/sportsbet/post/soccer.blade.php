<ul class="grid__EventListBodyWrapper-ljbzft-0 bfDTRZ match_{{$question['id']}}" itemscope="" itemtype="https://schema.org/SportsEvent" variant="asian-desktop">
    ...
    <li class="grid__Home1X2-jq9sb4-3 iKPMp option_{{$question['data']['1x2'][$option1]['question_id']}}_{{$question['data']['1x2'][$option1]['id']}}">
        @if(isset($question['data']['1x2'][$option1]) && $question['data']['1x2'][$option1]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="{{$option1}}" data-type="1x2" data-id="{{$question['data']['1x2'][$option1]['id']}}" data-question="{{$question['data']['1x2'][$option1]['question_id']}}">
    ...
    <li class="grid__Away1X2-jq9sb4-4 vzgLe option_{{$question['data']['1x2'][$option2]['question_id']}}_{{$question['data']['1x2'][$option2]['id']}}">
        @if(isset($question['data']['1x2'][$option2]) && $question['data']['1x2'][$option2]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="{{$option2}}" data-type="1x2" data-id="{{$question['data']['1x2'][$option2]['id']}}" data-question="{{$question['data']['1x2'][$option2]['question_id']}}">
    ...
    <li class="grid__Draw1X2-jq9sb4-5 btXGYI option_{{$question['data']['1x2'][$option3]['question_id']}}_{{$question['data']['1x2'][$option3]['id']}}">
        @if(isset($question['data']['1x2'][$option3]) && $question['data']['1x2'][$option3]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="Draw" data-type="1x2" data-id="{{$question['data']['1x2'][$option3]['id']}}" data-question="{{$question['data']['1x2'][$option3]['question_id']}}">
    ...
    <li class="grid__HomeHCP-jq9sb4-8 dHMwDp option_{{$question['data']['hcp'][$option1]['question_id']}}_{{$question['data']['hcp'][$option1]['id']}}">
        @if(isset($question['data']['hcp'][$option1]) && $question['data']['hcp'][$option1]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="{{$option1}}" data-type="Handicap" data-id="{{$question['data']['hcp'][$option1]['id']}}" data-question="{{$question['data']['hcp'][$option1]['question_id']}}">
    ...
    <li class="grid__AwayHCP-jq9sb4-9 geniht option_{{$question['data']['hcp'][$option2]['question_id']}}_{{$question['data']['hcp'][$option2]['id']}}">
        @if(isset($question['data']['hcp'][$option2]) && $question['data']['hcp'][$option2]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="{{$option2}}" data-type="Handicap" data-id="{{$question['data']['hcp'][$option2]['id']}}" data-question="{{$question['data']['hcp'][$option2]['question_id']}}">
    ...
    <li class="grid__HomeTOT-jq9sb4-10 gGHKFY option_{{$question['data']['tot'][$option1]['question_id']}}_{{$question['data']['tot'][$option1]['id']}}">
        @if(isset($question['data']['tot'][$option1]) && $question['data']['tot'][$option1]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="" data-type="Total Goal" data-id="{{$question['data']['tot'][$option1]['id']}}" data-question="{{$question['data']['tot'][$option1]['question_id']}}">
    ...
    <li class="grid__AwayTOT-jq9sb4-11 jByJBO option_{{$question['data']['tot'][$option2]['question_id']}}_{{$question['data']['tot'][$option2]['id']}}">
        @if(isset($question['data']['tot'][$option2]) && $question['data']['tot'][$option2]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="" data-type="Total Goal" data-id="{{$question['data']['tot'][$option2]['id']}}" data-question="{{$question['data']['tot'][$option2]['question_id']}}">
    ...
    <li class="grid__FirstHalfHome1X2-jq9sb4-14 ijNPnK option_{{$question['data']['1h 1x2'][$option1]['question_id']}}_{{$question['data']['1h 1x2'][$option1]['id']}}">
        @if(isset($question['data']['1h 1x2'][$option1]) && $question['data']['1h 1x2'][$option1]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="{{$option1}}" data-type="1st Half - 1x2" data-id="{{$question['data']['1h 1x2'][$option1]['id']}}" data-question="{{$question['data']['1h 1x2'][$option1]['question_id']}}">
    ...
    <li class="grid__FirstHalfAway1X2-jq9sb4-15 ckgoaB option_{{$question['data']['1h 1x2'][$option2]['question_id']}}_{{$question['data']['1h 1x2'][$option2]['id']}}">
        @if(isset($question['data']['1h 1x2'][$option2]) && $question['data']['1h 1x2'][$option2]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="{{$option2}}" data-type="1st Half - 1x2" data-id="{{$question['data']['1h 1x2'][$option2]['id']}}" data-question="{{$question['data']['1h 1x2'][$option2]['question_id']}}">
    ...
    <li class="grid__FirstHalfDraw1X2-jq9sb4-16 kHupyM option_{{$question['data']['1h 1x2'][$option3]['question_id']}}_{{$question['data']['1h 1x2'][$option3]['id']}}">
        @if(isset($question['data']['1h 1x2'][$option3]) && $question['data']['1h 1x2'][$option3]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="Draw" data-type="1st Half - 1x2" data-id="{{$question['data']['1h 1x2'][$option3]['id']}}" data-question="{{$question['data']['1h 1x2'][$option3]['question_id']}}">
    ...
    <li class="grid__FirstHalfHomeHCP-jq9sb4-17 dAcRU option_{{$question['data']['1st half hcp'][$option1]['question_id']}}_{{$question['data']['1st half hcp'][$option1]['id']}}">
        @if(isset($question['data']['1st half hcp'][$option1]) && $question['data']['1st half hcp'][$option1]['ratio2'] > 0)
    ...
    <li class="grid__FirstHalfAwayHCP-jq9sb4-18 glEDYr option_{{$question['data']['1st half hcp'][$option2]['question_id']}}_{{$question['data']['1st half hcp'][$option2]['id']}}">
        @if(isset($question['data']['1st half hcp'][$option2]) && $question['data']['1st half hcp'][$option2]['ratio2'] > 0)
    ...
    <li class="grid__FirstHalfHomeTOT-jq9sb4-19 fcEWGd option_{{$question['data']['1st half tot'][$option1]['question_id']}}_{{$question['data']['1st half tot'][$option1]['id']}}">
        @if(isset($question['data']['1st half tot'][$option1]) && $question['data']['1st half tot'][$option1]['ratio2'] > 0)
    ...
    <li class="grid__FirstHalfAwayTOT-jq9sb4-20 DSIxD option_{{$question['data']['1st half tot'][$option2]['question_id']}}_{{$question['data']['1st half tot'][$option2]['id']}}">
        @if(isset($question['data']['1st half tot'][$option2]) && $question['data']['1st half tot'][$option2]['ratio2'] > 0)
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$question['name']}}" data-option="}}" data-type="1st Half - Total" data-id="{{$question['data']['1st half tot'][$option2]['id']}}" data-question="{{$question['data']['1st half tot'][$option2]['question_id']}}">
                <p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$question['data']['1st half tot'][$option2]['ratio1']}}</p>
                <p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{number_format($question['data']['1st half tot'][$option2]['ratio2'],2)}}</p>
            </div>
        @else
            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX">
                <svg class="IconPadlock-sc-1wkm386-0 eJrPzX" fill="none" height="1em" viewbox="0 0 24 24" width="1em" xmlns="http://www.w3.org/2000/svg">
