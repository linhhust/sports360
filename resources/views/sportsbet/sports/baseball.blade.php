...
<div class="ListEventContainer__EventsWrapper-sc-2quhzy-4 cxCKIF">
			<div>
				<div class="summary__SummaryWrapper-b40yh6-0 ceRxxX">
					...
					<p class="summary__SummaryCaption-b40yh6-1 llGbUT">{{$season['name']}}</p>
					<div class="summary__EventCount-b40yh6-2 gZeRne">
						<p class="summary__SummaryCaption-b40yh6-1 HMZTp">{{count($season['data'])}}</p>
					</div>
				</div>
				...
				@foreach($season['data'] as $match)
					<ul itemscope="" itemtype="https://schema.org/SportsEvent" variant="asian-desktop" class="grid__EventListBodyWrapper-ljbzft-0 bfDTRZ">
						<li itemprop="location" itemscope="" itemtype="https://schema.org/Place" style="display: none;">
							<meta itemprop="name" content="USA" property="">
							<meta itemprop="address" content="USA" property="">
						</li>
						<meta itemprop="name" content="{{$season['name']}}" property="">
						<meta itemprop="description" content="{{$season['name']}} USA MLB" property="">
						<meta itemprop="startDate" content="2021-06-10T17:10:00.000Z" property="">
						<li class="grid__HomeCompetitor-jq9sb4-0 eFFTax">
							<a class="CompetitorWithScore__CompetitorWrapper-v0fmv1-0 ifMAfU" itemprop="homeTeam" itemscope="" itemtype="https://schema.org/SportsTeam" href="javascript:void(0)">
								...
								<p itemprop="name" class="CompetitorWithScore__Name-v0fmv1-1 bAXEiS">{{isset($match['teams'][0])?$match['teams'][0]['name']:''}}</p>
								<p class="CompetitorWithScore__Scores-v0fmv1-2 aBgbT">
									<span class="CompetitorWithScore__Score-v0fmv1-3 qLfpg">{{isset($match['teams'][0])?$match['teams'][0]['score']:''}}</span>
								</p>
							</a>
						</li>
						<li class="grid__AwayCompetitor-jq9sb4-1 eAKYok">
							<a class="CompetitorWithScore__CompetitorWrapper-v0fmv1-0 ifMAfU" itemprop="awayTeam" itemscope="" itemtype="https://schema.org/SportsTeam" href="/sports/event/baseball/usa/mlb/detroit-tigers-seattle-mariners-60c1b56fa2b818e1a744767a">
								<meta itemprop="sport" content="Baseball" property="">
								<p itemprop="name" class="CompetitorWithScore__Name-v0fmv1-1 bAXEiS">{{isset($match['teams'][1])?$match['teams'][1]['name']:''}}</p>
								<p class="CompetitorWithScore__Scores-v0fmv1-2 aBgbT">
									<span class="CompetitorWithScore__Score-v0fmv1-3 qLfpg">{{isset($match['teams'][1])?$match['teams'][1]['score']:''}}</span>
								</p>
							</a>
						</li>
						<li class="grid__EventInfo-jq9sb4-2 isoPst">
							<div class="AsianEventInfo__Time-sc-3u4nbe-0 eTrGsW">
								<p class="AsianEventInfo__Caption-sc-3u4nbe-1 dkGcvN">{{$type == 2 ? '' : $match['time']}}</p>
						...
						<li class="grid__HomeWinner-jq9sb4-6 bIUEeK">
							@if(isset($match['options'][$match['teams'][0]['name']]['winner']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="Winner (incl. overtime)">
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][0]['name']]['winner']['ratio2']}}</p>
								</div>
	                        @else
	                            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
						...
						<li class="grid__AwayWinner-jq9sb4-7 bxcQYe">
							@if(isset($match['options'][$match['teams'][1]['name']]['winner']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="Winner (incl. overtime)">
									<p class="Selection__Odds-sc-1tx8nkd-0 ireQWm">{{$match['options'][$match['teams'][1]['name']]['winner']['ratio2']}}</p>
								</div>
							@else
	                            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
						...
						<li class="grid__HomeHCP-jq9sb4-8 dHMwDp">
							@if(isset($match['options'][$match['teams'][0]['name']]['hcp']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="Handicap (incl. overtime)">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][0]['name']]['hcp']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][0]['name']]['hcp']['ratio2']}}</p>
								</div>
							@else
	                            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
						...
						<li class="grid__AwayHCP-jq9sb4-9 geniht">
							@if(isset($match['options'][$match['teams'][1]['name']]['hcp']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="Handicap (incl. overtime)">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][1]['name']]['hcp']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 iAtQcF">{{$match['options'][$match['teams'][1]['name']]['hcp']['ratio2']}}</p>
								</div>
							@else
	                            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
						...
						<li class="grid__HomeTOT-jq9sb4-10 gGHKFY">
							@if(isset($match['options'][$match['teams'][0]['name']]['tot']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="Total (incl. overtime)">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][0]['name']]['tot']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 iAtQcF">{{$match['options'][$match['teams'][0]['name']]['tot']['ratio2']}}</p>
								</div>
							@else
	                            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
						...
						<li class="grid__AwayTOT-jq9sb4-11 jByJBO">
							@if(isset($match['options'][$match['teams'][1]['name']]['tot']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="Total (incl. overtime)">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][1]['name']]['tot']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 iAtQcF">{{$match['options'][$match['teams'][1]['name']]['tot']['ratio2']}}</p>
								</div>
							@else
	                            <div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
						...
						<li class="grid__FirstHalfHomeWinner-jq9sb4-12 cVQWRz">
							@if(isset($match['options'][$match['teams'][0]['name']]['1st half winner']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="1st Half - Winner">
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][0]['name']]['1st half winner']['ratio2']}}</p>
								</div>
							@else
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
						...
						<li class="grid__FirstHalfAwayWinner-jq9sb4-13 cnpGOH">
							@if(isset($match['options'][$match['teams'][1]['name']]['1st half winner']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Winner">
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][1]['name']]['1st half winner']['ratio2']}}</p>
								</div>
							@else
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half Winner">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
										<path d="M4.107 12.536L4 18.256c0 1.166.853 2.12 2.027 2.332 2.56.318 7.253.741 11.946 0C19.147 20.376 20 19.422 20 18.257l-.213-5.721c0-1.166-.96-2.013-2.134-2.225-2.56-.106-7.04-.424-11.413.106-1.173.106-2.027 1.06-2.133 2.119z" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M16.267 10.31V7.345C16.267 5.014 14.24 3 11.893 3 9.547 3 7.52 4.907 7.52 7.344v2.967" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M12 14v3.137" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
						...
						<li class="grid__FirstHalfHomeHCP-jq9sb4-17 dAcRU">
							@if(isset($match['options'][$match['teams'][0]['name']]['1st half hcp']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="1st Half - Asian Handicap">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][0]['name']]['1st half hcp']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][0]['name']]['1st half hcp']['ratio2']}}</p>
								</div>
							@else
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="1st Half - Asian Handicap">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
										<path d="M4.107 12.536L4 18.256c0 1.166.853 2.12 2.027 2.332 2.56.318 7.253.741 11.946 0C19.147 20.376 20 19.422 20 18.257l-.213-5.721c0-1.166-.96-2.013-2.134-2.225-2.56-.106-7.04-.424-11.413.106-1.173.106-2.027 1.06-2.133 2.119z" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M16.267 10.31V7.345C16.267 5.014 14.24 3 11.893 3 9.547 3 7.52 4.907 7.52 7.344v2.967" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M12 14v3.137" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
						...
						<li class="grid__FirstHalfAwayHCP-jq9sb4-18 glEDYr">
							@if(isset($match['options'][$match['teams'][1]['name']]['1st half hcp']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Handicap">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][1]['name']]['1st half hcp']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][1]['name']]['1st half hcp']['ratio2']}}</p>
								</div>
							@else
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Handicap">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
										<path d="M4.107 12.536L4 18.256c0 1.166.853 2.12 2.027 2.332 2.56.318 7.253.741 11.946 0C19.147 20.376 20 19.422 20 18.257l-.213-5.721c0-1.166-.96-2.013-2.134-2.225-2.56-.106-7.04-.424-11.413.106-1.173.106-2.027 1.06-2.133 2.119z" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M16.267 10.31V7.345C16.267 5.014 14.24 3 11.893 3 9.547 3 7.52 4.907 7.52 7.344v2.967" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M12 14v3.137" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
						...
						<li class="grid__FirstHalfHomeTOT-jq9sb4-19 fcEWGd">
							@if(isset($match['options'][$match['teams'][0]['name']]['1st half tot']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="1st Half - Asian Handicap">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][0]['name']]['1st half tot']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][0]['name']]['1st half tot']['ratio2']}}</p>
								</div>
							@else
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][0]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
										<path d="M4.107 12.536L4 18.256c0 1.166.853 2.12 2.027 2.332 2.56.318 7.253.741 11.946 0C19.147 20.376 20 19.422 20 18.257l-.213-5.721c0-1.166-.96-2.013-2.134-2.225-2.56-.106-7.04-.424-11.413.106-1.173.106-2.027 1.06-2.133 2.119z" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M16.267 10.31V7.345C16.267 5.014 14.24 3 11.893 3 9.547 3 7.52 4.907 7.52 7.344v2.967" stroke="currentColor" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round"></path>
										<path d="M12 14v3.137" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
						...
						<li class="grid__FirstHalfAwayTOT-jq9sb4-20 DSIxD">
							@if(isset($match['options'][$match['teams'][1]['name']]['1st half tot']))
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 bGbaJS" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Handicap">
									<p class="Selection__Name-sc-1tx8nkd-1 eieSeJ">{{$match['options'][$match['teams'][1]['name']]['1st half tot']['ratio1']}}</p>
									<p class="Selection__Odds-sc-1tx8nkd-0 ilfAV">{{$match['options'][$match['teams'][1]['name']]['1st half tot']['ratio2']}}</p>
								</div>
							@else
								<div class="Selection__SelectionWrapper-sc-1tx8nkd-2 gjAamX" data-info="{{$season['name']}}" data-option="{{$match['teams'][1]['name']}}" data-type="1st Half - Asian Total">
									<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="IconPadlock-sc-1wkm386-0 eJrPzX">
