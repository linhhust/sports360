                ...
                <div class="layout__IdLayoutBody-h90yrz-2 cxzNhQ">
                    <div class="body__IdBody-sc-1kb3j31-0 iwdBQt">
                        ...
                        <div class="body__IdBodyItem-sc-1kb3j31-1 jBPoYd">
                            <h1 size="32" data-test-id="loginPage-heading" color="bulma.100" class="Heading-sc-1fj2bsx-0 typography__IdHeading-sy3hob-0 hDOeka">Reset Password</h1>
                            @csrf
                                    ...
                                    <ul class="Stack-saln32-0 fMcwwO">
                                        <li class="FormItem-sc-5ofmdi-0 btCexx label_username">
                                            <label class="label__LabelFlex-sc-4w9rwl-1">
                                                ...
                                                <input class="Input-bxe8t3-0 TextInput__TextInputElem-xu44xk-0 dfVTHf hMFjBq" type="email" name="email" value="{{$email}}" placeholder="@lang('Email Address')" readonly>
                                        ...
                                        <li class="FormItem-sc-5ofmdi-0 btCexx label_username">
                                            <label class="label__LabelFlex-sc-4w9rwl-1">
                                                <span class="label__LabelContent-sc-4w9rwl-0 gfoyzb">@lang('New Password')</span>
                                                <input class="Input-bxe8t3-0 TextInput__TextInputElem-xu44xk-0 dfVTHf hMFjBq" type="password" name="password" value="" placeholder="@lang('New Password')">
                                                {{-- <input type="email" placeholder="e.g. you@example.com" required="" data-test-id="signupPage-emailField" value="{{old('email')}}" class="Input-bxe8t3-0 TextInput__TextInputElem-xu44xk-0 dfVTHf hMFjBq" name="email"> --}}
                                            </label>
                                        ...
                                        <li class="FormItem-sc-5ofmdi-0 btCexx label_username">
                                            <label class="label__LabelFlex-sc-4w9rwl-1">
                                                <span class="label__LabelContent-sc-4w9rwl-0 gfoyzb">@lang('Re Password')</span>
                                                <input class="Input-bxe8t3-0 TextInput__TextInputElem-xu44xk-0 dfVTHf hMFjBq" type="password" name="password_confirmation" value="" placeholder="@lang('Re Password')">
                                            </label>
                                        </li>
                                        <li class="FormItem-sc-5ofmdi-0 btCexx"><button
                                                ...
                                                <div class="Button__InnerContainer-sc-1xtdszg-1 dAOyev">Submit</div>
                                            </button></li>
